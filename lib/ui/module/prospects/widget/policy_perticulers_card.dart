...
import 'package:broking/ui/module/prospects/widget/policy_item_card.dart';
...
class PolicyCard extends BaseStateLessWidget {
    ...
    return Obx(() => isCollapse.value?Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [Column(children: [Column(children: formData,)])]
  ...
  List<Widget> get formData {
    for(int i=0;i<=policies.length-1;i++){
      policyWidgetList.add(PolicyItemCard(policies: policies[i], index: i,));
    }
  ...
  Widget labelAndTextField(
      String label, String text, TextEditingController controller,List<TextInputFormatter>? inputFormatters) {
