...
class RenewableCard extends BaseStateLessWidget {
  RenewableCard({super.key, required this.prospectViewData});
  ...
  Widget get cardHeader {
    return  InkWell(
      ...
      child: Obx(()=>isCollapse.value?Row(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              rowColumn("parentCompany",
                  prospectViewData.prospectDetails?.parentCompany ?? ""),
              dataVisible()
            ],
          ),
        )),);
        ...
        InkWell(
          onTap: () {
            actionPerform(Get.context!,
                "whatApp"); /*Uri.parse("whatsapp://send?phone=+919087898765&text=hello");*/
          },
          child: Padding(
            padding: const EdgeInsets.all(10),
            child: ClipOval(
  ...
  Widget dataVisible() {
    return Obx(() => isCollapse.value?Column(
      children: [
        ...
        rowColumn("Premium Potential", prospectViewData.prospectDetails?.premiumPotential??"0"),
  ...
  Widget contactItem(Contactperson data,int index) {
    ...
    widget.add(rowColumn("Email ", data.email));
  ...
  Widget policyPerticuller(Policies data,int index) {
    ...
    if(index>0)const Divider(color: Palette.appColor,),
        ...
        InkWell(onTap: (){_launchUrl(data.policyFile);},child: rowColumn("View Doc", "Tap to view"),),
      ],
    );
  }
