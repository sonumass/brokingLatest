import 'package:broking/controllers/meeting/meeting_prospect_controller.dart';
import 'package:broking/ui/dialog/loader.dart';
import 'package:broking/ui/module/meetings/widget/meeting_prospect_card.dart';
...
class MyMeetingProspectList extends AppPageWithAppBar {
  static const String routeName = "/MyMeetingProspectList";
  final controller=Get.put(MeetingProspectController());
  ...
  MyMeetingProspectList({super.key});
  @override
  ...
  @override
  Widget get body {
    controller.callMeetingProspectApi();
                ...
                if (controller.meetingList.isNotEmpty)
                  SliverList(
                    delegate: SliverChildBuilderDelegate(
                        ...
                        return MeetingProspectCard(meetingProspect:controller.meetingList[index]);
                      },
                      childCount: controller.meetingList.length, // 1000 list items
                    ),
                  ),
              ],
            ),)));
