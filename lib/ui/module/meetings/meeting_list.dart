...
class MeetingListPage extends AppPageWithAppBar {
  static const String routeName = "/MeetingListPage";
  final controller=Get.put(MeetingController());
  

  static Future<bool?> start<bool>(String prospectId,String name,String address,{type=""}) {
    return navigateTo<bool>(currentPageTitle: "Meeting", routeName,arguments: {"prospectId":prospectId,"name":name,"address":address,"type":type});
  }
  ...
  List<Widget>? get action => [
        InkWell(
          onTap: () {
            MeetingDashboard.start(arguments["prospectId"],
                arguments["name"], arguments["address"]);
  ...
  @override
  Widget get body {
    controller.callMeetingApi(arguments["type"],arguments["prospectId"]);
    ...
    return Container(
     width: screenWidget,
      ...
      decoration: const BoxDecoration(
        image: DecorationImage(
          fit: BoxFit.fitWidth,
          image: AssetImage("assets/png/ic_rounded.png"),
        ),),
      child: SizedBox(width: screenWidget,height:100,child: Center(child:
      Padding(padding: const EdgeInsets.only(top: 18),child: Text(
        arguments["name"],
