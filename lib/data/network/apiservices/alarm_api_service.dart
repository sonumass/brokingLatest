...
class AlarmApiServices extends DioClient {
  final client = DioClient.client;
  Future<AlarmModel?> alarmApi(String email,String userId) async {
    ...
    try {
      final response = await client.post(
          "${Constant.baseUrl}/broking/api/alarmset",
          data: inputData,
      ...
      try {
        ...
        alarmModel = AlarmModel.fromJson(data);
      } catch (e) {
