...
class RenewableListController extends BaseController {
  ...
  void renewableListApi({type}) async {
    isLoader.value=true;
    final response = await apiServices.renewableListApi(appPreferences.email,appPreferences.userId,appPreferences.officeId);
